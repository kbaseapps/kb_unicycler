...
/**
 * <p>Original spec-file module name: gaprice_SPAdes</p>
 * <pre>
...
public class GapriceSPAdesClient {
     ...
     */
    public GapriceSPAdesClient(URL url) {
     ...
     * validity.
     */
    public GapriceSPAdesClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public GapriceSPAdesClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * </pre>
     * @param   params   instance of type {@link us.kbase.gapricespades.SPAdesParams SPAdesParams}
     * @return   parameter "output" of type {@link us.kbase.gapricespades.SPAdesOutput SPAdesOutput}
    ...
    public SPAdesOutput runSPAdes(SPAdesParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<SPAdesOutput> res = caller.jsonrpcCall("gaprice_SPAdes.run_SPAdes", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
}
