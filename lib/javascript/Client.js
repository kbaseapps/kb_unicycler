...
function kb_SPAdes(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_SPAdes = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_SPAdes.run_SPAdes",
            [params], 1, _callback, _errorCallback);
    };
 
<<<<<<< HEAD
     this.run_HybridSPAdes = function (params, _callback, _errorCallback) {
=======
     this.run_metaSPAdes = function (params, _callback, _errorCallback) {
>>>>>>> 6dca079a8ed0f63796970b2b92b867de9c1e0201
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
<<<<<<< HEAD
        return json_call_ajax(_url, "kb_SPAdes.run_HybridSPAdes",
=======
...
>>>>>>> 6dca079a8ed0f63796970b2b92b867de9c1e0201
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_SPAdes.status",
